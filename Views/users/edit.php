...
<body>
    ...
    <div class="heading">CẬP NHẬT THÔNG TIN NHÂN VIÊN</div>
	<a class="js-add btn-them">Cập nhật thông tin nhân viên</a>
	<div class="modal">
		<div class="modal-container">
			<div class="modal-close"><i class="ti-close"></i></div>
			<header class="modal-header"><i class="ti-bag"></i>CẬP NHẬT THÔNG TIN NHÂN VIÊN</header>
			<div class="body">
                <form action='index.php?controller=user&action=update&id=<?php echo $student['id'] ?>' method='POST'>
				<label for="code" class="modal-label"><i class="ti-menu-alt"></i>Mã nhân viên</label>
                <input id='code' type='text' class='modal-input' name='employeecode' value='<?php echo $student['employeecode'] ?>' placeholder='Nhập mã phòng ban' required='' autocomplete='off'>
				<label for="name" class="modal-label"><i class="ti-info"></i>Tên nhân viên</label>
				<input id='name' type='text' class='modal-input' name='fullname' value='<?php echo $student['fullname'] ?>'  placeholder='Nhập tên phòng ban' required='' autocomplete='off'>
